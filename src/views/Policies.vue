  ...
  <section class="section">
    <div class="container">
      <div class="content">
        ...
        <p>
          Cultiva Tu Hongo te informa sobre su Política de Privacidad respecto
          ...
          contratación de servicios a través del sitio Web cultivatuhongo.com y
          derivados.
        </p>
        <p>
        ...
        <ul>
          <li>Titular: Cultiva Tu Hongo S.L.</li>
          <li>NIF/CIF: 57633097L</li>
          <li>Domicilio: Tenerife</li>
          <li>Correo electrónico: cultivatuhongo@info.com</li>
          <li>Sitio Web: cultivatuhongo.com</li>
        </ul>
        ...
        <ul>
          <li>
            ...
            Titular siempre requerirá el consentimiento para el tratamiento de
            tus datos personales que puede ser para uno o varios fines
            específicos sobre los que te informará previamente con absoluta
            transparencia.
          </li>
          <li>
            <strong>Principio de minimización de datos:</strong> El Titular te
            solicitará solo los datos estrictamente necesarios para el fin o los
          ...
          <li>
            ...
            para el fin o los fines del tratamiento. El Titular te informará del
            plazo de conservación correspondiente según la finalidad. En el caso
            de suscripciones, el Titular revisará periódicamente las listas y
          ...
          <li>
            ...
            confidencialidad e integridad esté garantizada. Debes saber que el
        ...
        <h1>Obtención de datos personales</h1>
        <p>
        ...
        <p>
          ...
          cultivatuhongo@info.com junto con la prueba válida en derecho como una
        ...
        <h1>Finalidad del tratamiento de datos personales</h1>
        <p>
        ...
        <ul>
          <li>
            <strong>Formularios de contacto:</strong> El Titular solicita datos
            personales entre los que pueden estar: Nombre y apellidos, dirección
            de correo electrónico, número de teléfono y dirección de tu sitio
            Web con la finalidad de responder a tus consultas. Por ejemplo, el
            Titular utiliza esos datos para dar respuesta a tus mensajes, dudas,
            quejas, comentarios o inquietudes que puedas tener relativas a la
          ...
          <li>
            <strong>Formularios de suscripción a contenidos:</strong> El Titular
            solicita los siguientes datos personales: Nombre y apellidos,
            dirección de correo electrónico, número de teléfono y dirección de
            tu sitio web para gestionar la lista de suscripciones, enviar
            boletines, promociones y ofertas especiales. Los datos que facilites
            al Titular estarán ubicados en los servidores de The Rocket Science
            Group LLC d/b/a, con domicilio en EEUU. (Mailchimp).
          </li>
        </ul>
        <p>
        ...
        <p>
          El sitio Web está alojado en Netlify. La seguridad de tus datos está
          garantizada, ya que toman todas las medidas de seguridad necesarias
          para ello. Puedes consultar su política de privacidad para tener más
          información.
        </p>
        <h1>Contenido de otros sitios web</h1>
        <p>
        ...
        <h1>Legitimación para el tratamiento de datos</h1>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            publicitarios proporcionado por Google, Inc., una compañía de
            ...
            tu ordenador y que sirven para aumentar la relevancia de los
            anuncios relacionados con tus búsquedas recientes. En la Política de
            privacidad de Google se explica cómo Google gestiona tu privacidad
            en lo que respecta al uso de las cookies y otra información.
          </li>
        </ul>
        <p>
        ...
        <h1>Navegación Web</h1>
        <p>
          Al navegar por cultivatuhongo.com y sitios derivados se pueden recoger
          datos no identificativos, que pueden incluir, la dirección IP,
          geolocalización, un registro de cómo se utilizan los servicios y
        ...
        <h1>Aceptación y consentimiento</h1>
        <p>
